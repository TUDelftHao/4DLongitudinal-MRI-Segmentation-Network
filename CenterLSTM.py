...
class CenterLSTMEncoder(init_U_Net, nn.Module):
    def __init__(self, input_modalites, output_channels, base_channel, is_pretrain=True):
        super(CenterLSTMEncoder, self).__init__(input_modalites, output_channels, base_channel)
    ...
    def forward(self, x):
        ...
        return block_3_pool, [block_1, block_2, block_3]

class CenterLSTMDecoder(init_U_Net, nn.Module):
    def __init__(self, input_modalites, output_channels, base_channel, is_pretrain=False):
        super(CenterLSTMDecoder, self).__init__(input_modalites, output_channels, base_channel)
    ...
    def forward(self, x, shortcat):
        block_1, block_2, block_3 = shortcat
...
class CenterLSTM(nn.Module):
    def __init__(
        ...
        super(CenterLSTM, self).__init__()

        self.num_layers = num_layers
        self.outdim = output_channels
        self.return_sequence = return_sequence

        self.encoder = CenterLSTMEncoder(input_modalites, output_channels, base_channel, is_pretrain=is_pretrain)
        self.decoder = CenterLSTMDecoder(input_modalites, output_channels, base_channel)
...
class BiCenterLSTM(CenterLSTM, nn.Module):
    def __init__(
        self,
        input_modalites,
        output_channels,
